...
import setKeyScene from "./scenes/setKeyScene";
...
// @ts-ignore
const stage = new Scenes.Stage<Scenes.WizardContext>([addSubsWizard, deleteSubsWizard, notifyUsersWizard, setKeyScene])
